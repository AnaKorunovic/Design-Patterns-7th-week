...
public final class Controller1 extends Kontroler{ //Client
   
    LogFactory lg; // FlyweightFactory
   
    
    public Controller1(EkranskaForma ef1,BrokerBazePodataka bbp1){ef=ef1;bbp=bbp1; Povezi(); lg = new LogFactory();}
...
boolean nadjiDomenskiObjekat(){
    boolean signal;
    bbp.makeConnection();
    DKIspitnaPrijava ip1 = (DKIspitnaPrijava)bbp.findRecord(ip); // Promenljivo!!!
    if (ip1 != null) 
...
{   Controller1 kon;
    ...
    OsluskivacZapamti(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacKreiraj(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacObrisi(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacPromeni(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacNadji(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacNadji1(Controller1 kon1) {kon = kon1;}
...
{   Controller1 kon;
    ...
    OsluskivacTekuciLog(Controller1 kon1) {kon = kon1;}
